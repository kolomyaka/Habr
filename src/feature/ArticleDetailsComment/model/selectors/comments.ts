...
export const getArticleDetailsCommentText = (state: StateSchema) => state.articleDetailsCommentForm?.text || '';
export const getArticleDetailsCommentError = (state: StateSchema) => state.articleDetailsCommentForm?.error;